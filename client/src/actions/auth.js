...
export const loadUser = () => async dispatch => {
    ...
    try {
        const res = await axios.get('api/auth'); //trying to authenticate in case there is a token in the localStorage
...
export const register = ({ name, email, password }) => async dispatch => {
    ...
    try {
        ...
        dispatch(loadUser());
        dispatch(setAlert('Registration was successul!', 'success'));
